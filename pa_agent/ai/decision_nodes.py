...
- DecisionNodeEngine: deterministic judge for §1.1/§2.3/§2.4/§9 nodes
...
class DecisionNodeEngine:
    ...
    def apply_stage2(
        ...
        """In-place modify stage2 JSON: fill §9.1/§9.2/§9.3/§9.5 and apply overrides."""
        ...
        # §11 is owned exclusively by ExecutionResolver after schema validation.
        program_nodes = [node_91, node_92, node_93, node_95]
